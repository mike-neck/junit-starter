...
class JunitStarterLibraryPlugin: Plugin<Project> {

    override fun apply(project: Project) {
        project.applyPluginIfNot(javaLibrary)
        ...
        project.dependencies {
            junitApi(JunitJupiter.api("testImplementation"))
            junitEngine(JunitJupiter.engine("testRuntimeOnly"))
        }
    }
